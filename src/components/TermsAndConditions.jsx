...
const TermsAndConditions = ({ className, onScrollEnd }) => {
  const { t } = useTranslation();

  const termsRef = useRef(null);

  const { ref, entry } = useIntersection({
    root: termsRef.current,
    threshold: 1,
  });
  ...
  return (
    <div
      className={cn("space-y-4 max-h-[70vh] overflow-y-auto", className)}
      ref={termsRef}
    >
      <div className="py-10">
        ...
        <div className="flex flex-col items-start text-left py-2" ref={ref}>
